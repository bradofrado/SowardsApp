...
export const colors = {...tailwindColors, ...baseConfig.theme.extend.colors} as unknown as ForceValueType<typeof fullConfig.theme.extend.colors & Omit<DefaultColors, 'gray'>, string, HexColor>;