...
import { DashboardIcon, UsersIcon, FolderIcon, CalendarIcon, DocumentDuplicateIcon, ChartPieIcon } from 'ui/src/components/core/icons'
...
const navigation = [
  ...
  { label: 'Documents', href: '#', icon: DocumentDuplicateIcon, current: false },
